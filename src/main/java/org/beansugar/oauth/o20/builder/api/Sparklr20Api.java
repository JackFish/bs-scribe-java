 ...
 */
@Slf4j
public class Sparklr20Api extends Default20Api {

	private static final String AUTHORIZE_URL = "http://localhost:8080/sparklr2/oauth/authorize?client_id=%s&redirect_uri=%s&response_type=code";
	private static final String SCOPED_AUTHORIZE_URL = AUTHORIZE_URL + "&scope=%s";

	@Override
	public String getAccessTokenUrl() {
		return "http://localhost:8080/sparklr2/oauth/token?grant_type=authorization_code";
	}
